...
const CanvasIcon = () => (
  <svg width="25" height="25" viewBox="0 0 100 100" fill="#fff">
    <g>
...
const QuizIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1f2937" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="max-w-2xl mx-auto py-6 px-6 space-y-3.5">
      ...
      >
        <div className="flex items-center gap-2 mb-1">
          <Link2 className="w-4 h-4 text-[#0033a0] flex-shrink-0" />
          <span className="font-black text-[15px]">Canvas course</span>
          {urlValid && courseName && (
            <CheckCircle2 className="w-[17px] h-[17px] text-green-500 ml-auto flex-shrink-0" />
          )}
        </div>
        ...
        <div className="flex gap-2">
          ...
          <input
            ...
            className="flex-1 min-w-0 border-2 border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:border-[#0033a0] transition"
          />
          <button
          ...
          <div className="mt-2.5 flex items-center gap-2 min-h-[1.25rem]">
            {courseName ? (
              <>
                ...
                <span className="text-sm font-black text-green-700">{courseName}</span>
              </>
            ) : (
      ...
      <p className="text-[12px] text-gray-500 uppercase tracking-wide font-black px-1 pt-1">Export tools</p>
